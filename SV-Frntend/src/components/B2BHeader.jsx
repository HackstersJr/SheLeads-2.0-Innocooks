...
export default function B2BHeader() {
    const { lang, toggleLang, t, isAuthenticated, logout } = useApp()
                ...
                <div className="flex items-center gap-2">
                    ...
                    {isAuthenticated && (
                        <button
                            ...
                            className="
                                w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0
                                bg-white/70 border border-stone-200/80 backdrop-blur-sm
                                text-stone-400 hover:text-rose-500 hover:border-rose-200/70 hover:bg-rose-50/80
